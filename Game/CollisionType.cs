...
public class CollisionType {
    ...
    */
    ...
    public bool CheckLightCollision(CollisionType collision) {
        if (this.NoLightCollision() || collision.NoLightCollision()) {
            return this._lightType == collision._lightType;
        } else {
            return ( this.IsLight() && collision.IsDarkness() ) || ( this.IsDarkness() && collision.IsLight() );
        }
    }
